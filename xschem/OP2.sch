...
N -20 -220 -20 -70 {lab=GND}
N -70 -70 -20 -70 {lab=GND}
N -180 -260 -70 -260 {lab=#net1}
N -180 -260 -180 -160 {lab=#net1}
N 40 -270 210 -270 {lab=vout}
N 0 -460 100 -460 {lab=vout}
N 100 -460 100 -270 {lab=vout}
...
.end
"}
C {opamp_model.sym} 80 -100 0 0 {name=x2}
C {lab_wire.sym} 160 -270 0 0 {name=p4 sig_type=std_logic lab=vout}
